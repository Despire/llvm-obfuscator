; ModuleID = 'input/block-extraction/ex9/ex9.cpp'
...
define void @_Z6renderffiPfPcii(float %0, float %1, i32 %2, float* nocapture %3, i8* nocapture %4, i32 %5, i32 %6) local_unnamed_addr #0 {
  ...
  %18 = call fastcc float @_ZL3cosf(float 5.000000e-01) #6
  %19 = call fastcc float @_ZL3cosf(float %1) #6
  %20 = call fastcc float @_ZL3sinf(float %1) #6
  br label %28

21:                                               ; preds = %133
  %22 = call fastcc float @_ZL3sinf(float 5.000000e-01) #6
  %23 = call fastcc float @_ZL3sinf(float %0) #6
  %24 = fcmp une float %23, 0.000000e+00
  %25 = fmul float %23, 2.000000e+00
  %26 = select i1 %24, float %25, float %23
  %27 = call fastcc float @_ZL3cosf(float %0) #6
  br label %139
...
32:                                               ; preds = %28
  %33 = call fastcc float @_ZL3sinf(float 5.000000e-01) #6
  br label %34

34:                                               ; preds = %28, %32
  %35 = phi float [ 0.000000e+00, %28 ], [ %33, %32 ]
  %36 = call fastcc float @_ZL3cosf(float %30) #6
  br label %37

37:                                               ; preds = %28, %34
  %38 = phi float [ 0.000000e+00, %28 ], [ %36, %34 ]
  %39 = phi float [ 0.000000e+00, %28 ], [ %35, %34 ]
  %40 = call fastcc float @_ZL3sinf(float %0) #6
  br label %41
...
41:                                               ; preds = %28, %37
  ...
  %45 = call fastcc float @_ZL3sinf(float %30) #6
  br label %46
...
46:                                               ; preds = %28, %41
  ...
  %51 = call fastcc float @_ZL3cosf(float %0) #6
  br label %52
...
126:                                              ; preds = %119
  store float %83, float* %123, align 4, !tbaa !10
  %127 = icmp sgt i32 %111, 0
  %128 = select i1 %127, i32 %111, i32 0
  %129 = zext i32 %128 to i64
  %130 = getelementptr inbounds [13 x i8], [13 x i8]* @.str, i64 0, i64 %129
...
133:                                              ; preds = %126, %119, %70
  ...
  br i1 %137, label %28, label %21, !llvm.loop !15
...
139:                                              ; preds = %21, %219
  ...
  %146 = call fastcc float @_ZL3cosf(float %142) #6
  ...
  %152 = call fastcc float @_ZL3sinf(float %142) #6
...
205:                                              ; preds = %139
  ...
  %210 = load float, float* %209, align 4, !tbaa !10
  %211 = fcmp ogt float %170, %210
  br i1 %211, label %212, label %219

212:                                              ; preds = %205
  store float %170, float* %209, align 4, !tbaa !10
  %213 = icmp sgt i32 %197, 0
  %214 = select i1 %213, i32 %197, i32 0
  %215 = zext i32 %214 to i64
  %216 = getelementptr inbounds [13 x i8], [13 x i8]* @.str, i64 0, i64 %215
...
219:                                              ; preds = %212, %205, %139
  ...
  br i1 %223, label %138, label %139, !llvm.loop !18
}
...
6:                                                ; preds = %0, %6
  ...
  %9 = icmp eq i32 %8, 10
  br i1 %9, label %11, label %6, !llvm.loop !19
...
11:                                               ; preds = %6, %11
  ...
  br i1 %24, label %10, label %11, !llvm.loop !20
}
