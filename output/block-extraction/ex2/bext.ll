; ModuleID = 'output/block-extraction/ex2/ex2.ll'
source_filename = "input/block-extraction/ex2/ex2.cpp"
...
define internal void @main..split(i32* %.out) #1 {
newFuncRoot:
  br label %.split

.split:                                           ; preds = %newFuncRoot
  %0 = call i32 @_Z8digitSumi(i32 15)
  %1 = call i32 @_Z8digitSumi(i32 25)
  %2 = add nsw i32 %1, %0
