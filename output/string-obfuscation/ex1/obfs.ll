...
@llvm.global_ctors = appending constant [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @init1597345799257524794, i8* null }]
...
define void @decode10152801917885972806(i8* %0, i32 %1, i8* %2, i32* %3, i8* %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init1597345799257524794() {
...
71:                                               ; preds = %0
  call void @decode10152801917885972806(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0), i32 23, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0), i32* %69, i8* %70)
...
118:                                              ; preds = %71
  call void @decode10152801917885972806(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @str, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @str, i32 0, i32 0), i32* %116, i8* %117)
...
165:                                              ; preds = %118
  call void @decode10152801917885972806(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @str.7, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @str.7, i32 0, i32 0), i32* %163, i8* %164)
...
220:                                              ; preds = %165
  call void @decode10152801917885972806(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.8, i32 0, i32 0), i32 14, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.8, i32 0, i32 0), i32* %218, i8* %219)
  ret void
}
