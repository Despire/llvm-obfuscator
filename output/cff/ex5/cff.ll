...
BogusBasciBlock:                                  ; preds = %entry, %"17", %"16", %"15", %"14", %"13", %"12", %"11", %"10", %LeafBlock, %NodeBlock, %NodeBlock1, %NodeBlock3, %NodeBlock5, %NodeBlock7, %NodeBlock9, %NodeBlock11, %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %"18"), i8** %25, align 8
  %26 = getelementptr i8*, i8** %JumpTable, i32 2
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %NodeBlock11), i8** %26, align 8
  %27 = getelementptr i8*, i8** %JumpTable, i32 4
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %EntryBasicBlockSplit), i8** %27, align 8
  ...
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %"17"), i8** %30, align 8
  %31 = getelementptr i8*, i8** %JumpTable, i32 12
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %"16"), i8** %31, align 8
  %32 = getelementptr i8*, i8** %JumpTable, i32 14
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %"12"), i8** %32, align 8
  %33 = getelementptr i8*, i8** %JumpTable, i32 16
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %NodeBlock7), i8** %33, align 8
  %34 = getelementptr i8*, i8** %JumpTable, i32 18
  store i8* blockaddress(@_Z12duffs_deviceiPiS_, %NodeBlock1), i8** %34, align 8
