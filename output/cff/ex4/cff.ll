...
BogusBasciBlock:                                  ; preds = %entry, %"9", %"8", %"7", %"6", %LeafBlock, %NodeBlock, %NodeBlock1, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store i8* blockaddress(@_Z6decideii, %"9"), i8** %15, align 8
  ...
  store i8* blockaddress(@_Z6decideii, %BogusBasciBlock), i8** %17, align 8
  ...
  store i8* blockaddress(@_Z6decideii, %"2"), i8** %19, align 8
