...
//void display(const char *output, float &a, float &b, int q) {
//    printf("\x1b[H");
    ...
    for (float theta = 0; theta < 6.28; theta += 0.07) {
        ...
        switch (int(theta) / 1) {
            ...
            case 4:
                cosA = cos(a);
            case 5:
                circleX = cosTheta + outer_size;
            case 6:
                circleY = sinPhi * circleX *cosA - sinTheta * sinA;
            case 7:
                ;
            case 8:
                ;
        ...
        int lum = 8 *
                  ((sinTheta * sinA - sinPhi * cosTheta * cosA) * cosB - sinPhi * cosTheta * sinA - sinTheta * cosA -
